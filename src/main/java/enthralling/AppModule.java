...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("-3869946840551483445 enthralling ab716409-e3cf-4955-a0ab-26aedac509b6 enthralling".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in enthralling package as a set of config entries
        return configLoader.fromResource("enthralling/settings");
    }
