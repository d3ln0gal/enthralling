...
public class AppServer {
    ...
    public static final String STATIC_LOCATION = System.getProperty("user.dir") + "/src/main/webapp/static";
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.setProperty("static.route", STATIC_LOCATION);
        System.setProperty("restx.mode", System.getProperty("restx.mode", "dev"));
        System.setProperty("restx.app.package", "enthralling");
        System.out.println("------------------------------------------------------");
        System.out.println(System.getProperty("static.route"));
